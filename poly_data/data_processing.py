...
from poly_data.trading_logic_director import director
...
def process_data(json_datas, trade=True):
    ...
    for json_data in json_datas:
        ...
        if event_type == 'book':
            ...
            if trade:
                director.schedule_trade(asset, reason="book_snapshot")
            ...
            for data in json_data['price_changes']:
                ...
                if trade:
                    director.schedule_trade(asset, reason="price_change")
            ...
            if row['event_type'] == 'trade':
                ...
                if row['status'] == 'CONFIRMED' or row['status'] == 'FAILED' :
                    if row['status'] == 'FAILED':
                        ...
                        director.schedule_trade(market, reason="trade_confirmed")
                    ...
                    print("Performing is ", global_state.performing)
                    print("Performing timestamps is ", global_state.performing_timestamps)
                    director.schedule_trade(market, reason="trade_matched")
                ...
                director.schedule_trade(market, reason="order_event")
